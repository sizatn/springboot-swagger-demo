...
import com.sizatn.ssd.common.Constants;
import com.sizatn.ssd.common.ErrorEnum;
import com.sizatn.ssd.common.exception.CommonJsonException;

/**
 * 
 * @desc 系统后台接口常用的json工具类
 * @author sizatn
 * @date Apr 20, 2018
 */
public class CommonUtil {
	...
	public static void hasAllRequired(final JSONObject jsonObject, String requiredColumns) {
		if (!Strings.isNullOrEmpty(requiredColumns)) {
			// 验证字段非空
			...
			if (!Strings.isNullOrEmpty(missCol)) {
				jsonObject.clear();
